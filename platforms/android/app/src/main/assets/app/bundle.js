...
/******/ 	var hotCurrentHash = "9c2826e5c680d38d095f";
...
/***/ "./app/@core/model/common.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Elite", function() { return Elite; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Result", function() { return Result; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TestResult", function() { return TestResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentAssetMapping", function() { return EquipmentAssetMapping; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Range", function() { return Range; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeRange", function() { return TimeRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SegDep", function() { return SegDep; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Quantity", function() { return Quantity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResProp", function() { return ResProp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OpProp", function() { return OpProp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonnelSpec", function() { return PersonnelSpec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentSpec", function() { return EquipmentSpec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialSpec", function() { return MaterialSpec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OpData", function() { return OpData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonnelOp", function() { return PersonnelOp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentOp", function() { return EquipmentOp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialOp", function() { return MaterialOp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonnelCap", function() { return PersonnelCap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentCap", function() { return EquipmentCap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialCap", function() { return MaterialCap; });
...
/* harmony import */ var _parameter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./app/@core/model/parameter.ts");
/* harmony import */ var _mdef__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./app/@core/model/mdef.ts");




var Elite = /** @class */ (function () {
    function Elite(e) {
...
var TestResult = /** @class */ (function () {
    function TestResult(tr) {
        ...
        this.testTime = tr && tr.testTime || moment__WEBPACK_IMPORTED_MODULE_1__();
        this.result = tr && tr.result || [];
        this.expirTime = tr && tr.expirTime || moment__WEBPACK_IMPORTED_MODULE_1__().add(2, 'h');
    }
    return TestResult;
}());

var EquipmentAssetMapping = /** @class */ (function () {
    function EquipmentAssetMapping(eaMap) {
...
var Range = /** @class */ (function () {
    function Range(range) {
        ...
        this.lower = range && range.lower || new _parameter__WEBPACK_IMPORTED_MODULE_2__["Value"]();
        this.upper = range && range.upper || new _parameter__WEBPACK_IMPORTED_MODULE_2__["Value"]();
    }
    return Range;
}());

var TimeRange = /** @class */ (function () {
    function TimeRange(trange) {
...
//Resource Property
var ResProp = /** @class */ (function () {
    function ResProp(rp) {
        this._id = rp && rp._id || undefined;
        this.oid = rp && rp.oid || '';
        this.desc = rp && rp.desc || '';
        this.value = rp && rp.value || new _parameter__WEBPACK_IMPORTED_MODULE_2__["Value"]();
...
var OpProp = /** @class */ (function () {
    function OpProp(opp) {
        this._id = opp && opp._id || undefined;
        this.oid = opp && opp.oid || '';
        this.desc = opp && opp.desc || '';
        this.value = opp && opp.value || new _parameter__WEBPACK_IMPORTED_MODULE_2__["Value"]();
...
var PersonnelSpec = /** @class */ (function () {
    function PersonnelSpec(ps) {
...
var EquipmentSpec = /** @class */ (function () {
    function EquipmentSpec(es) {
...
var MaterialSpec = /** @class */ (function () {
    function MaterialSpec(ms) {
    ...
    MaterialSpec.prototype.deriveFromMdef = function (mdef) {
        var strOids = this.oid.split('-');
        this.oid = strOids[0] + '-' + mdef.oid;
        this.mdef = new _mdef__WEBPACK_IMPORTED_MODULE_3__["MdefElite"](mdef);
        this.desc = mdef.desc;
    };
    MaterialSpec.prototype.deriveFromMdefProfile = function (mdef) {
        var strOids = this.oid.split('-');
        this.oid = strOids[0] + '-' + mdef.oid;
        this.mdef = new _mdef__WEBPACK_IMPORTED_MODULE_3__["MdefElite"](mdef);
    };
...
var PersonnelOp = /** @class */ (function () {
    function PersonnelOp(po) {
     ...
     */
    PersonnelOp.prototype.DeriveFromPersonnelOps = function (pos) {
        this.oid = pos[0].oid;
        this.pclass = pos[0].pclass;
        this.person = pos[0].person;
        this.desc = pos[0].desc;
        this.use = pos[0].use;
        this.qty.quantity = pos.map(function (item) { return item.qty.quantity; })
            .reduce(function (prev, curr) { return prev + curr; });
        this.qty.unit = pos[0].qty.unit;
        this.hs = pos[0].hs;
        this.opprop = lodash__WEBPACK_IMPORTED_MODULE_0__["uniqBy"](lodash__WEBPACK_IMPORTED_MODULE_0__["flatten"](pos.map(function (item) { return item.opprop; })), '_id');
    };
    return PersonnelOp;
}());

var EquipmentOp = /** @class */ (function () {
    function EquipmentOp(eo) {
     ...
     */
    EquipmentOp.prototype.DeriveFromEquipmentOps = function (eos) {
        this.oid = eos[0].oid;
        this.eclass = eos[0].eclass;
        this.equipment = eos[0].equipment;
        this.desc = eos[0].desc;
        this.use = eos[0].use;
        this.qty.quantity = eos.map(function (item) { return item.qty.quantity; })
            .reduce(function (prev, curr) { return prev + curr; });
        this.qty.unit = eos[0].qty.unit;
        this.hs = eos[0].hs;
        this.opprop = lodash__WEBPACK_IMPORTED_MODULE_0__["uniqBy"](lodash__WEBPACK_IMPORTED_MODULE_0__["flatten"](eos.map(function (item) { return item.opprop; })), '_id');
    };
    return EquipmentOp;
}());

var MaterialOp = /** @class */ (function () {
    function MaterialOp(mo) {
...
var PersonnelCap = /** @class */ (function () {
    function PersonnelCap(pc) {
...
var EquipmentCap = /** @class */ (function () {
    function EquipmentCap(ec) {
...
var MaterialCap = /** @class */ (function () {
    function MaterialCap(mc) {
...
var GlobalData = /** @class */ (function () {
     ...
     * @type {IMdef}
     */
    GlobalData.dummyBody = undefined;
    /**
...
/***/ "./app/@core/model/mclass.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Mclass", function() { return Mclass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MclassElite", function() { return MclassElite; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MclassProfile", function() { return MclassProfile; });
/* harmony import */ var _data_util_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./app/@core/data/util.service.ts");
...
var Mclass = /** @class */ (function () {
    function Mclass(mc) {
        ...
        this.assType = mc && mc.assType || _data_util_service__WEBPACK_IMPORTED_MODULE_0__["MaterialData"].assemblyTypes[0];
        this.assRel = mc && mc.assRel || _data_util_service__WEBPACK_IMPORTED_MODULE_0__["MaterialData"].assemblyRelations[0];
        this.mdefs = mc && mc.mdefs || [];
    }
    Mclass.prototype.GetElite = function () {
...
var MclassElite = /** @class */ (function () {
    function MclassElite(mce) {
...
var MclassProfile = /** @class */ (function () {
    function MclassProfile(mcp) {
        ...
        this.assType = mcp && mcp.assType || _data_util_service__WEBPACK_IMPORTED_MODULE_0__["MaterialData"].assemblyTypes[0];
        this.assRel = mcp && mcp.assRel || _data_util_service__WEBPACK_IMPORTED_MODULE_0__["MaterialData"].assemblyRelations[0];
    }
    return MclassProfile;
}());
...
/***/ "./app/@core/model/mdef.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Quantity", function() { return Quantity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Mdef", function() { return Mdef; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MdefElite", function() { return MdefElite; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MdefProfile", function() { return MdefProfile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MdefInfo", function() { return MdefInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Mrd", function() { return Mrd; });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _mclass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./app/@core/model/mclass.ts");
/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./app/@core/model/global.ts");
/* harmony import */ var _data_util_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./app/@core/data/util.service.ts");
...
var Mdef = /** @class */ (function () {
    function Mdef(m) {
        ...
        this.assType = m && m.assType || _data_util_service__WEBPACK_IMPORTED_MODULE_3__["MaterialData"].assemblyTypes[0];
        this.assRel = m && m.assRel || _data_util_service__WEBPACK_IMPORTED_MODULE_3__["MaterialData"].assemblyRelations[0];
        this.mclass = m && m.mclass || [];
        this.rdlog = m && m.rdlog || [];
    }
    //从多个Pclass中继承相关属性，
    Mdef.prototype.DeriveFromMclasses = function (mcs) {
        var _this = this;
        this.hs = mcs[0].hs;
        mcs.forEach(function (item) {
            _this.prop = lodash__WEBPACK_IMPORTED_MODULE_0__["unionBy"](_this.prop, item.prop, '_id');
        });
        this.mclass = mcs.map(function (item) {
            return new _mclass__WEBPACK_IMPORTED_MODULE_1__["MclassElite"](item);
        });
        this.assType = mcs[0].assType;
        this.assRel = mcs[0].assRel;
    };
    Mdef.prototype.GetElite = function () {
        return new MdefElite(this);
    };
    Mdef.prototype.importPara = function (paraName, value) {
        var para = _global__WEBPACK_IMPORTED_MODULE_2__["GlobalData"].paras.find(function (item) { return item.oid === paraName; });
        if (para) {
            var prop = lodash__WEBPACK_IMPORTED_MODULE_0__["cloneDeep"](para);
            prop.value = value;
            this.prop.push(prop);
        }
    };
...
var MdefElite = /** @class */ (function () {
    function MdefElite(me) {
...
var MdefProfile = /** @class */ (function () {
    function MdefProfile(mp) {
...
var MdefInfo = /** @class */ (function () {
    function MdefInfo(mi) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ParameterElite", function() { return ParameterElite; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ParameterProfile", function() { return ParameterProfile; });
...
var ParameterElite = /** @class */ (function () {
    function ParameterElite(pe) {
        this._id = pe && pe._id || undefined;
        this.oid = pe && pe.oid || '';
    }
    return ParameterElite;
}());

var ParameterProfile = /** @class */ (function () {
    function ParameterProfile(pp) {
...
/* harmony import */ var _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.ts");
/* harmony import */ var _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_show_job_show_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: "workOrderOverview/jobOrder/:id", component: _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_component__WEBPACK_IMPORTED_MODULE_14__["JobOrderComponent"] },
    { path: "workOrderOverview/jobOrder/job-show/:oid", component: _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_show_job_show_component__WEBPACK_IMPORTED_MODULE_15__["JobShowComponent"] },
...
/* harmony import */ var _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.ts");
/* harmony import */ var _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_show_job_show_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.ts");
/* harmony import */ var _mobileTerminal_mobile_pages_common_autoCompleteTextView_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__("./app/mobileTerminal/mobile-pages/common/autoCompleteTextView.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_component__WEBPACK_IMPORTED_MODULE_31__["JobOrderComponent"],
                _mobileTerminal_mobile_pages_workOrderOverview_jobOrder_jobOrder_show_job_show_component__WEBPACK_IMPORTED_MODULE_32__["JobShowComponent"],
                _mobileTerminal_mobile_pages_common_autoCompleteTextView_component__WEBPACK_IMPORTED_MODULE_33__["AutoCompleteTextViewComponent"]
            ],
            imports: [
...
/***/ "./app/mobileTerminal/mobile-pages/common/autoCompleteTextView.component.html":
/***/ (function(module, exports) {

module.exports = "<RadAutoCompleteTextView #autocomplete [items]=\"dataItems\" suggestMode=\"Suggest\" displayMode=\"Plain\">\r\n  <SuggestionView tkAutoCompleteSuggestionView suggestionViewHeight=\"300\">\r\n    <ng-template tkSuggestionItemTemplate let-item=\"item\">\r\n      <StackLayout orientation=\"vertical\" padding=\"10\">\r\n        <Label [text]=\"item.text\"></Label>\r\n      </StackLayout>\r\n    </ng-template>\r\n  </SuggestionView>\r\n</RadAutoCompleteTextView>\r\n"

/***/ }),

/***/ "./app/mobileTerminal/mobile-pages/common/autoCompleteTextView.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AutoCompleteTextViewComponent", function() { return AutoCompleteTextViewComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var nativescript_ui_autocomplete_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/nativescript-ui-autocomplete/angular/autocomplete-directives.js");
/* harmony import */ var nativescript_ui_autocomplete_angular__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(nativescript_ui_autocomplete_angular__WEBPACK_IMPORTED_MODULE_1__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AutoCompleteTextViewComponent = /** @class */ (function () {
    function AutoCompleteTextViewComponent() {
        this.array = new Array();
    }
    Object.defineProperty(AutoCompleteTextViewComponent.prototype, "items", {
        set: function (items) {
            this.array = items;
        },
        enumerable: true,
    ...
    AutoCompleteTextViewComponent.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(AutoCompleteTextViewComponent.prototype, "dataItems", {
        get: function () {
            return this._items;
        },
        enumerable: true,
    ...
    __decorate([
        ...
        __metadata("design:type", nativescript_ui_autocomplete_angular__WEBPACK_IMPORTED_MODULE_1__["RadAutoCompleteTextViewComponent"])
    ], AutoCompleteTextViewComponent.prototype, "autocomplete", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], AutoCompleteTextViewComponent.prototype, "items", null);
    AutoCompleteTextViewComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: "mes-m-radAutoCompleteTextView",
            /*duleId: module.i*/
            template: __webpack_require__("./app/mobileTerminal/mobile-pages/common/autoCompleteTextView.component.html"),
            styleUrls: [],
            providers: []
        }),
        __metadata("design:paramtypes", [])
    ], AutoCompleteTextViewComponent);
    return AutoCompleteTextViewComponent;
}());
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-order.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobOrderService", function() { return JobOrderService; });
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("../node_modules/rxjs/_esm5/operators/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobOrderService = /** @class */ (function () {
    function JobOrderService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
     ...
     * @param result - optional value to return as the observable result
     */
    JobOrderService.prototype.handleError = function (operation, result) {
        var _this = this;
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
    ...
    /** Log a HeroService message with the MessageService */
    JobOrderService.prototype.log = function (message) {
     ...
     * 当查询不到时，返回 undefined
     */
    JobOrderService.prototype.getJobOrderNo404 = function (query) {
        var _this = this;
        var qstr = '';
        if (query) {
            lodash__WEBPACK_IMPORTED_MODULE_4__["forOwn"](query, function (value, key) {
                qstr += key + "=" + value + "&";
            });
        }
        else {
        ...
        var url = this.baseUrl + "/api/jobOrders/?" + qstr;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (jos) { return jos[0]; }), // returns a {0|1} element array
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (jo) {
            var outcome = jo ? "fetched" : "did not find";
            _this.log(outcome + " JobOrder _id=" + qstr);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError("getJobOrderNo404 " + qstr)));
    };
    JobOrderService = __decorate([
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-response.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobResponseService", function() { return JobResponseService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _core_data_message_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./app/@core/data/message.service.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("../node_modules/rxjs/_esm5/index.js");
...
var JobResponseService = /** @class */ (function () {
    function JobResponseService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.baseUrl = 'http://100.13.32.238:9000';
    }
     ...
     * @param result - optional value to return as the observable result
     */
    JobResponseService.prototype.handleError = function (operation, result) {
        var _this = this;
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
    ...
    /** Log a HeroService message with the MessageService */
    JobResponseService.prototype.log = function (message) {
        this.messageService.add("WorkResponseService: " + message);
    };
    /**
     * 通过查询条件，获取层级信息
     * 当查询不到时，返回 undefined
     */
    JobResponseService.prototype.getJobResponseNo404 = function (query) {
        var _this = this;
        var qstr = '';
        if (query) {
            lodash__WEBPACK_IMPORTED_MODULE_4__["forOwn"](query, function (value, key) {
        ...
        var url = this.baseUrl + "/api/jobResponses/?" + qstr;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (jrs) { return jrs[0]; }), // returns a {0|1} element array
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (jr) {
            var outcome = jr ? "fetched" : "did not find";
            _this.log(outcome + " JobResponse _id=" + qstr);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError("getIJobResponse " + qstr)));
    };
    JobResponseService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            _core_data_message_service__WEBPACK_IMPORTED_MODULE_2__["MessageService"]])
    ], JobResponseService);
    return JobResponseService;
}());
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.css":
/***/ (function(module, exports) {
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.html":
/***/ (function(module, exports) {
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobShowComponent", function() { return JobShowComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _core_model_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./app/@core/model/common.ts");
/* harmony import */ var nativescript_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("../node_modules/nativescript-angular/index.js");
/* harmony import */ var nativescript_angular__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(nativescript_angular__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _job_order_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-order.service.ts");
/* harmony import */ var _job_response_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-response.service.ts");
/* harmony import */ var nativescript_loading_indicator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("../node_modules/nativescript-loading-indicator/loading-indicator.js");
/* harmony import */ var nativescript_loading_indicator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(nativescript_loading_indicator__WEBPACK_IMPORTED_MODULE_8__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobShowComponent = /** @class */ (function () {
    function JobShowComponent(router, route, location, joService, jrService, routerExtensions) {
        this.router = router;
        this.route = route;
        ...
        this.routerExtensions = routerExtensions;
        //产出的可选的呈现类型
        this.qtyTypes = ['仅物料', '物料+成型工'];
        //产出呈现的类型
        this.qtyType = this.qtyTypes[0];
        /**
         * [工单的进度值]
         * @type {number}
         */
        ...
        //缺陷率subtitle
        this.qSubtitle = "";
        this.indicator = new nativescript_loading_indicator__WEBPACK_IMPORTED_MODULE_8__["LoadingIndicator"]();
    }
    JobShowComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoaderNoBezel();
        var oid = this.route.snapshot.paramMap.get('oid');
        this.joService.getJobOrderNo404({ oid: oid }).subscribe(function (jo) {
            _this.jo = jo;
            _this.jrService.getJobResponseNo404({ oid: oid }).subscribe(function (jr) {
                _this.jr = jr;
                _this.init();
                _this.hideIndicator();
            });
    ...
    JobShowComponent.prototype.init = function () {
        if (this.jo && this.jr) {
            this.jo.qty = new _core_model_common__WEBPACK_IMPORTED_MODULE_4__["Quantity"]();
            this.jo.qty.quantity = this.jo.mReq.map(function (mr) { return mr.qty.quantity; }).reduce(function (prev, curr) { return prev + curr; });
            this.totalQty = {
                quantity: this.jr.ngqty.quantity + this.jr.qty.quantity,
                unit: this.jr.qty.unit
            };
            this.processValue = this.jo.qty.quantity === 0 ? 0 : lodash__WEBPACK_IMPORTED_MODULE_3__["round"](this.jr.qty.quantity / this.jo.qty.quantity * 100, 2);
            ...
            this.qPer = this.jr.ngqty.quantity === 0 ? 0 : lodash__WEBPACK_IMPORTED_MODULE_3__["round"](this.jr.ngqty.quantity / this.totalQty.quantity * 100, 2);
            this.qTitle = "缺陷率" + this.qPer + "%";
            this.qSubtitle = this.jr.ngqty.quantity + "/" + this.totalQty.quantity + this.jr.qty.unit;
        }
    };
    JobShowComponent.prototype.showLoaderNoBezel = function () {
        this.indicator.show({
            message: '正在加载中...',
            ...
            android: {
                ...
                hideBezel: true,
                mode: nativescript_loading_indicator__WEBPACK_IMPORTED_MODULE_8__["Mode"].CustomView,
                indeterminate: true,
                // cancelable: true,
    ...
    JobShowComponent.prototype.hideIndicator = function () {
        this.indicator.hide();
    };
    /**
     * [返回上一级]
     */
    JobShowComponent.prototype.backToJobOrder = function () {
        this.routerExtensions.back();
    };
    JobShowComponent.prototype.ngAfterViewChecked = function () {
        //完成率
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], JobShowComponent.prototype, "scaleElement", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("myScale1"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], JobShowComponent.prototype, "scaleElement1", void 0);
    JobShowComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'mes-m-job-show',
            template: __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.html"),
            styles: [__webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder-show/job-show.component.css")],
            providers: [_job_order_service__WEBPACK_IMPORTED_MODULE_6__["JobOrderService"], _job_response_service__WEBPACK_IMPORTED_MODULE_7__["JobResponseService"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"],
            _job_order_service__WEBPACK_IMPORTED_MODULE_6__["JobOrderService"],
            _job_response_service__WEBPACK_IMPORTED_MODULE_7__["JobResponseService"],
            nativescript_angular__WEBPACK_IMPORTED_MODULE_5__["RouterExtensions"]])
    ], JobShowComponent);
    return JobShowComponent;
}());
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.css":
/***/ (function(module, exports) {
...
/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.html":
/***/ (function(module, exports) {

module.exports = "<ActionBar class=\"action-bar\">\r\n  <NavigationButton\r\n    ios:visibility=\"collapsed\"\r\n    icon=\"~/app/mobileTerminal/fonts/返回.png\"\r\n    (tap)=\"backToWorkOrder()\"\r\n  ></NavigationButton>\r\n  <Label class=\"action-bar-title\" text=\"工单概览\" horizontalAlignment=\"left\"></Label>\r\n</ActionBar>\r\n\r\n<ScrollView class=\"page\">\r\n  <ListView class=\"list-group\" [items]=\"jobOrders\" >\r\n    <ng-template let-item=\"item\" let-i=\"index\">\r\n      <GridLayout class=\"list-group-item\" rows=\"*\" columns=\"1/10*, 7/10*, 2/10*\">\r\n        <Label row=\"0\" col=\"0\" class=\"label1\" [text]=\"i+1\"></Label>\r\n        <Label row=\"0\" col=\"1\" class=\"label2\" [text]=\"item.oid\"></Label>\r\n        <Image row=\"0\" col=\"2\" src=\"~/app/mobileTerminal/fonts/图表200#0e932e.png\" class=\"thumb img-circle\" (tap)=\"onChartTap(item.oid)\"></Image>\r\n      </GridLayout>\r\n    </ng-template>\r\n  </ListView>\r\n</ScrollView>\r\n"

/***/ }),

/***/ "./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobOrderComponent", function() { return JobOrderComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _workOrderOverview_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/workOrderOverview.service.ts");
...
var JobOrderComponent = /** @class */ (function () {
    function JobOrderComponent(routerExtensions, route, workOrderOverviewService) {
        this.routerExtensions = routerExtensions;
        this.route = route;
        this.workOrderOverviewService = workOrderOverviewService;
        this.jobOrders = [];
    }
    JobOrderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.workOrderOverviewService.getWorkRequest(this.route.snapshot.params.id)
            .subscribe(function (val) {
            if (val && val.jobOrder) {
                _this.jobOrders = val.jobOrder;
            }
        });
    };
    JobOrderComponent.prototype.onChartTap = function (oid) {
        this.routerExtensions.navigate(["/workOrderOverview/jobOrder/job-show/" + oid]);
    };
    JobOrderComponent.prototype.backToWorkOrder = function () {
        this.routerExtensions.back();
    };
    JobOrderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: "mes-m-job",
            /*duleId: module.i*/
            template: __webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.html"),
            styles: [__webpack_require__("./app/mobileTerminal/mobile-pages/workOrderOverview/jobOrder/jobOrder.component.css")],
            providers: [_workOrderOverview_service__WEBPACK_IMPORTED_MODULE_1__["WorkOrderOverviewService"]]
        }),
        __metadata("design:paramtypes", [nativescript_angular__WEBPACK_IMPORTED_MODULE_2__["RouterExtensions"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            _workOrderOverview_service__WEBPACK_IMPORTED_MODULE_1__["WorkOrderOverviewService"]])
    ], JobOrderComponent);
    return JobOrderComponent;
}());
...
var WorkResComponent = /** @class */ (function () {
    ...
    WorkResComponent.prototype.backToWorkOrder = function () {
        this.routerExtensions.back();
    };
    ...
    WorkOrderOverviewComponent.prototype.onTextChanged = function (args) {
        ...
        if (!lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](filterObj)) {
            ...
            if (!lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.queryArray)) {
                var listArray_1 = this.filterWorkRequestList.filter(function (val) { return _this.queryArray.includes(val.oid); });
                (_a = this.workRequestList).push.apply(_a, listArray_1);
            }
        }
        else {
            //将之前查询条件的结果添加到数组中
            if (!lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.queryArray)) {
                ...
                (_b = this.workRequestList).push.apply(_b, listArray);
            }
            else {
                //无任何查询条件，展示全部数据
    ...
    WorkOrderOverviewComponent.prototype.onTokenRemoved = function (args) {
        ...
        if (index > -1) {
            ...
            if (this.queryArray.length > 0) {
                ...
                //如果存在则剔除出去
                if (exist_1) {
                    this.workRequestList.splice(workRequestIndex_1, 1);
                }
            }
            else {
                if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.stringQuery)) {
                    this.workRequestList = this.filterWorkRequestList;
                }
            }
            //最后从查询条件数组中删除出去
...
var WorkOrderOverviewService = /** @class */ (function () {
     ...
     */
    WorkOrderOverviewService.prototype.searchWorkRequests = function (query, field, sort, limit, skip) {
        var _this = this;
        if (field === void 0) { field = ''; }
        if (sort === void 0) { sort = '-_id'; }
        ...
        var url = this.baseUrl + "/api/workRequests/?" + qstr + "field=" + field + "&sort=" + sort + "&limit=" + limit + "&skip=" + skip;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("found WorkRequests matching \"" + qstr + "\""); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('searchWorkRequests', [])));
    };
    /**
     ...
     */
    WorkOrderOverviewService.prototype.getWorkRequestsEliteBy = function (query) {
