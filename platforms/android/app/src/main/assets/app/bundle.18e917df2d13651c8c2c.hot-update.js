...
var WorkOrderOverviewComponent = /** @class */ (function () {
    ...
    WorkOrderOverviewComponent.prototype.onTokenRemoved = function (args) {
        ...
        if (index > -1) {
            ...
            console.log(workRequestIndex_1, "workRequestIndex!!!");
            //如果存在则剔除出去
            if (exist_1) {
                this.workRequestList = this.workRequestList.slice(workRequestIndex_1, 1);
                console.log(this.workRequestList.length, "exist!!!");
            }
        }
    };
